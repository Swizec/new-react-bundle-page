...
export const Jumbotron = () => (
    <DarkSection hasBottom="leftSlope">
        <header className="section-header underline">
            ...
            <p><i>React has arrived.</i> The ecosystem is stabilizing, the best practices are emerging, the engineers who use it are in love.❤️  <i>Now is the time to get in</i>.</p>
